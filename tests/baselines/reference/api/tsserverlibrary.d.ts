...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        TemplateSpan = 234,
        SemicolonClassElement = 235,
        Block = 236,
        EmptyStatement = 237,
        VariableStatement = 238,
        ...
        ThrowStatement = 252,
        TryStatement = 253,
        DebuggerStatement = 254,
        VariableDeclaration = 255,
        VariableDeclarationList = 256,
        FunctionDeclaration = 257,
        ClassDeclaration = 258,
        InterfaceDeclaration = 259,
        TypeAliasDeclaration = 260,
        EnumDeclaration = 261,
        ModuleDeclaration = 262,
        ModuleBlock = 263,
        CaseBlock = 264,
        NamespaceExportDeclaration = 265,
        ImportEqualsDeclaration = 266,
        ImportDeclaration = 267,
        ImportClause = 268,
        NamespaceImport = 269,
        NamedImports = 270,
        ImportSpecifier = 271,
        ExportAssignment = 272,
        ExportDeclaration = 273,
        NamedExports = 274,
        NamespaceExport = 275,
        ExportSpecifier = 276,
        MissingDeclaration = 277,
        ExternalModuleReference = 278,
        JsxElement = 279,
        JsxSelfClosingElement = 280,
        JsxOpeningElement = 281,
        JsxClosingElement = 282,
        JsxFragment = 283,
        JsxOpeningFragment = 284,
        JsxClosingFragment = 285,
        JsxAttribute = 286,
        JsxAttributes = 287,
        JsxSpreadAttribute = 288,
        JsxExpression = 289,
        CaseClause = 290,
        DefaultClause = 291,
        HeritageClause = 292,
        ...
        AssertClause = 294,
        AssertEntry = 295,
        ImportTypeAssertionContainer = 296,
        PropertyAssignment = 297,
        ShorthandPropertyAssignment = 298,
        SpreadAssignment = 299,
        EnumMember = 300,
        UnparsedPrologue = 301,
        UnparsedPrepend = 302,
        UnparsedText = 303,
        UnparsedInternalText = 304,
        UnparsedSyntheticReference = 305,
        SourceFile = 306,
        Bundle = 307,
        UnparsedSource = 308,
        InputFiles = 309,
